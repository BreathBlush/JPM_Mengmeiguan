...
\def\@makeenmark{\hbox{\tiny{\normalfont\@theenmark}\small}}

\def\enoteformat{\rightskip\z@ \leftskip\z@ \parindent=1.2em
  \leavevmode\llap{\makeenmark}\rightskip 0.5em\setlength{\hangindent}{1.5em}\small\kaishu}
